...
<header>
    <div class="container-fluid" style="font-size: 13px; background-color: white;border-bottom:1px solid grey">
        <div id="left-header" >
            <a href="{{URL::asset('/')}}" target="_self" title="Về trang chủ">
                <img class="animated bounce" src="{{URL::asset('/img/img/logo4.png')}}" width="110px" height="64px"/>
                <span href={{url('/')}}>Hệ thống đặt phòng khách sạn</span>
            </a>
        </div>
        ...
        <div id="right-header">
            @if(@Auth::user()->role_id==2)
                <div style="float: left; border-right: solid thin rgb(238,238,238); margin: 0px 5px 0px 5px">
                    <a href="{{ url('partner/apply') }}" style="margin-right: 5px">Đăng ký đối tác</a></li>
                </div>
            @endif
            <div style="float: left; border-right: solid thin rgb(238,238,238)">
                <a href="#promotion" style="margin-right: 5px">Các địa điểm du lịch tại Ninh Bình</a></li>
            </div>
