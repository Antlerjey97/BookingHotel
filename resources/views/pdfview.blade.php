        ...
        <div class="container">
          <center>
            ...
            <div class="panel panel-default">
              <div class="panel-heading"><h1><b>Hotel Booking</b></h1></div>
                <a href="/user/reservations" ><b>Quay lại</b> </a>
            ...
            <div class="panel panel-default">
                <div class="panel-heading"><h3><b>Chi tiết đặt phòng</b></h3>
                    @if($showdetails->status==0)
                        <span><b style="color: red">Phòng đã Hủy</b></span>
                    @else
                    @endif</div>
                <div class="panel-body">
                    ...
                    <p><b>Tổng giá:</b>{{number_format($showdetails->totalPrice,0)}} vnd</p>
                </div>
            </div>
